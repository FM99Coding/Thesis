...
log_dir=os.path.join(script_dir, 'logs') #directory of logs data
...
def start_external_scripts():
    ...
    processes.append(subprocess.Popen(['python3', os.path.join(script_dir, 'TopoDiscovery2.py')],
                                      stdout=topo_log, stderr=subprocess.STDOUT))
    processes.append(subprocess.Popen(['python3', os.path.join(script_dir, 'FlowDiscovery.py')],
                                      stdout=flow_log, stderr=subprocess.STDOUT))
    processes.append(subprocess.Popen(['python3', os.path.join(script_dir, 'ECMProuting.py')],
